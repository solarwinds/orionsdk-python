...
class Solarwinds:
    ...
    def delete_dependency(self, dependency_name):
        """ Delete a dependency that has the specified dependency name.
        ...
        self.swis.invoke('Orion.Dependencies', 'RemoveDependencies', [self.get_dependency_id(dependency_name)])
